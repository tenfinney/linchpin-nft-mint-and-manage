export default {
  ...
  "title": "Evidencer Claim Registry with Attestation",
  ...
  "properties": {
    ...
    "otherPublicIdentity": {
      "type": "string",
      "title": "Non-Worldlaw Public Identity Hash",
      "description": "Enter a Uport, Blockstack or 3box public identity hash (minimum 16 characters).",
      "minLength": 16,
      "pattern": "\\d+"
    },
    ...
    "activeClaim": {
      "type": "boolean",
      "title": "Use this form submission to update a previous Worldlaw Evidencer submission,"
    },
    ...
    "stringFormats": {
      ...
      "title": "Supplemental Contact Information",
    ...
    "defaultsAndMinItems": {
      ...
      "type": "array",
      "title": "The E.S.I. Collection Phases",
      "description": "select the time frame the E.S.I. evidence was captured. Delete all instances that are not applicable the the collection and storing of your Tidbits E.S.I. evidence)",
      "minItems": 5,
      "default": [
        "contemporaneous",
        "post_event",
    ...
    "unorderable": {
      "title": "Worldlaw Adjudication Option",
      "description": "Select why you are filing this claim. Delete any selections that do not apply to your goals in adjudicating your claim.",
      "type": "array",
      "items": {
        "type": "string",
        "default": "UnorderableOption"
      }
    },


    "unremovable": {
      "title": "Worldlaw Adjudication Preference",
      "description": "Select and put in order of importance how you would like to resolve your claim. You may not remove any choices, just put them in order of your preference.",
      "type": "array",
      "items": {
        "type": "string",
        "default": "UnremoveablePreference"
      }
    },
    ...
    "boolean": {
      ...
      "title": "Evidencer Claim Initiator",
      ...
      "properties": {
        ...
        "default": {
          "type": "boolean",
          "title": "Yes, please execute this Evidencer form along with the Worldlaw Tidbits hashes as proof of my claim.",
          "description": "I want to file a legal claim to be adjudicated under the Worldlaw Judiciary"
        },
        ...
        "radio": {
          ...
          "description": "I am the victim of a crime or tort."
        },


        "select": {
          "type": "boolean",
          "title": "The Cause of Action is a contract dispute.",
          "description": "I am the victim of a contract breach or fraud."
        }
    ...
    "string": {
      ...
      "title": "Enter a description of the event(s) giving rise to the claim.",
      ...
      "properties": {
        ...
        "default": {
          "type": "string",
          "title": "Enter short decription of the facts here:"
        },


        "textarea": {
          "type": "string",
          "title": "Enter detailed decription of the facts here:"
        }
...
2024
    ...
    "pass2": {
      "title": "Repeat password to secure the Evidencer portal",
      "type": "string",
      "minLength": 4
    },
    ...
    "public_ethereumAddress": {
      "type": "string",
      "title": "Evidencer's Public Ethereum Address",
